...
import com.example.sqlix.service.authentication.JwtService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            // Chỉ authentication nếu SecurityContext chưa có user
            if (email != null
            ...
            // SecurityConfig sẽ xử lý nếu endpoint yêu cầu login.
        }
